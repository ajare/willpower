...
private:
  // Default implementations are no-ops; parameter names are omitted so the
  // header stays warning-clean under -Wall -Wextra on GCC/Clang (MSVC's
  // C4100 suppression above covers the same ground).
