...
#	if defined(WP_WAYFINDER_DLL_EXPORT)
#		define WP_WAYFINDER_API __declspec( dllexport )
#	elif defined(WP_WAYFINDER_STATIC_LIB)
#		define WP_WAYFINDER_API
#	else
#		if defined(__MINGW32__)
#			define WP_WAYFINDER_API
#		else
#			define WP_WAYFINDER_API __declspec( dllimport )
#		endif
#	endif
#elif WP_PLATFORM == WP_PLATFORM_LINUX
#	if defined(WP_WAYFINDER_DLL_EXPORT)
#		define WP_WAYFINDER_API __attribute__((visibility("default")))
#	else
#		define WP_WAYFINDER_API
#	endif
#endif
